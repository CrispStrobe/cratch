...
class GUI extends React.Component {
    componentDidMount () {
        ...
        setProjectIdMetadata(this.props.projectId);
         window.loadProjectFromUrl = this.props.loadProjectFromUrl;
...
GUI.propTypes = {
    ...
    vm: PropTypes.instanceOf(VM).isRequired,
     loadProjectFromUrl: PropTypes.func
};
...
window.loadProjectFromUrl = WrappedGui.WrappedComponent.loadProjectFromUrl;
