...
sprites.forEach(sprite => {
    sprite.costumes.forEach(costume => {
        localImages[costume.assetId] = require(`../assets/ressources/${costume.md5ext}`);
    });
});

backdrops.forEach(backdrop => {
        localImages[backdrop.assetId] = require(`../assets/ressources/${backdrop.md5ext}`);
});

sounds.forEach(sound => {
        localImages[sound.assetId] = require(`../assets/ressources/${sound.md5ext}`);
});
...
class LibraryItem extends React.PureComponent {
    ...
    curIconMd5 () {
        ...
        getIconUrl(md5) {
        if (localImages[md5.split('.')[0]]) {
            return localImages[md5.split('.')[0]];
        }
        return `https://cdn.assets.scratch.mit.edu/internalapi/asset/${md5}/get/`;
    }
    render () {
        ...
        const iconURL = iconMd5 ? this.getIconUrl(iconMd5) :
