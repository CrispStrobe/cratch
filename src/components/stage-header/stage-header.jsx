...
import clavier from '../menu-bar/clavier.svg';
...
const StageHeaderComponent = function (props) {
    ...
    let header = null;
    const keyboard=document.getElementById("item");
    ...
    if (isFullScreen) {
        ...
        const stageButton = showBranding ? (
            ...
            <a
                    href="#"
                     onClick={() => keyboard.style.display=='block'?keyboard.style.display='none':keyboard.style.display='block'}

                >
                    <img
                        alt="Clavier"
                        src={clavier}
                        className={styles.clavierF}
                    />
                </a>
                <Button
